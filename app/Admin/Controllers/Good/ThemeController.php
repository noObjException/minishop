...
class ThemeController extends Controller
{
        ...
        return Admin::content(function (Content $content) {
            ...
            $content->row(function (Row $row) {
                ...
                $row->column(6, function (Column $column) {
                    ...
                    $form->action(admin_base_path('good/themes'));

                    $form->number('sort', __('field.sort'));
                    $form->select('pid', __('field.parent'))->options(GoodTheme::selectOptions());
    ...
    {
        return GoodTheme::tree(function (Tree $tree) {
            $tree->disableCreate();
    ...
    {
        return Admin::form(GoodTheme::class, function (Form $form) {
